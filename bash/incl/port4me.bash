...
PORT4ME_EXCLUDE_BUILTIN=${PORT4ME_EXCLUDE_BUILTIN:-"{chrome},{mozilla}"}
...
_p4m_ports_excluded_by_chrome() {
    ## Source: https://chromium.googlesource.com/chromium/src.git/+/refs/heads/master/net/base/port_util.cc
    ## Last updated: 2022-10-24
    echo "1 7 9 11 13 15 17 19 20 21 22 23 25 37 42 43 53 69 77 79 87 95 101 102 103 104 109 110 111 113 115 117 119 123 135 137 139 143 161 179 389 427 465 512 513 514 515 526 530 531 532 540 548 554 556 563 587 601 636 989 990 993 995 1719 1720 1723 2049 3659 4045 5060 5061 6000 6566 6665 6666 6667 6668 6669 6697 10080"
}

_p4m_ports_excluded_by_mozilla() {
    ## Source: https://www-archive.mozilla.org/projects/netlib/portbanning#portlist
    ## Last updated: 2022-10-24
    echo "1 7 9 11 13 15 17 19 20 21 22 23 25 37 42 43 53 77 79 87 95 101 102 103 104 109 110 111 113 115 117 119 123 135 139 143 179 389 465 512 513 514 515 526 530 531 532 540 556 563 587 601 636 993 995 2049 4045 6000"
}
...
_p4m_parse_ports() {
    ...
    spec=${spec//,/ }
    spec=${spec//\{chrome\}/$(_p4m_ports_excluded_by_chrome)}
    spec=${spec//\{mozilla\}/$(_p4m_ports_excluded_by_mozilla)}
    spec=${spec//+( )/ }
    spec=${spec## }
    spec=${spec%% }
    spec=${spec// /$'\n'}
