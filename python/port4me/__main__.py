...
#parser.add_argument("--prepend", type=list, help="A list of ports to try first")
#parser.add_argument("--include", type=list, help="If specified, skip any ports not in this list")
#parser.add_argument("--exclude", type=list, help="Skip any ports in this list")
